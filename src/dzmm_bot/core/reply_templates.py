...
TEMPLATE_DEFINITIONS = (
    ...
    TemplateDefinition("/投票", "recorded", "已记录投票", "投票已记录，等待其他存活玩家投票。", ("{日期}",)),
    ...
    TemplateDefinition("/投票", "settled", "对局结束", "【谁是卧底】{淘汰玩家} 出局，身份：{身份}。\n{胜利阵营}阵营获胜。发送 /继续 可开启下一局。", ("{淘汰玩家}", "{身份}", "{胜利阵营}", "{日期}")),
    ...
    TemplateDefinition("/蹦蹦数字炸弹", "usage", "创建格式", "请用 /蹦蹦数字炸弹 3-10 创建报名局。", ("{日期}",)),
    TemplateDefinition("/蹦蹦数字炸弹", "signup_started", "报名开启", "【蹦蹦数字炸弹】{昵称} 发起了 {人数} 人局，当前 {当前人数}/{人数} 人，请发送 /加入 报名。", ("{昵称}", "{人数}", "{当前人数}", "{日期}")),
    ...
    TemplateDefinition("/蹦蹦数字炸弹", "idle_timeout", "无操作超时", "蹦蹦数字炸弹长时间无人操作，本场已自动结束。", ("{日期}",)),
    TemplateDefinition("/加入", "number_bomb_joined", "数字炸弹报名", "{昵称} 已加入蹦蹦数字炸弹，当前 {当前人数}/{人数} 人。", ("{昵称}", "{当前人数}", "{人数}", "{日期}")),
