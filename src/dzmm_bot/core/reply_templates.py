...
TEMPLATE_DEFINITIONS = (
    ...
    TemplateDefinition("/摸鱼躲猫猫", "usage", "玩法说明", "请用 /摸鱼躲猫猫 发起游戏，或 /摸鱼躲猫猫 躲 编号 选择地点。", ("{日期}",)),
    ...
    TemplateDefinition("/摸鱼躲猫猫", "already_active", "正在选择地点", "你有一局躲猫猫正在选择地点，请先用 /摸鱼躲猫猫 躲 编号 完成选择。", ("{日期}",)),
    TemplateDefinition("/摸鱼躲猫猫", "not_enough_scenes", "地点不足", "当前可用躲猫猫地点不足 7 个，请联系管理员配置。", ("{日期}",)),
    TemplateDefinition("/摸鱼躲猫猫", "started", "选择躲藏地点", "{昵称}，躲猫猫开始，已扣除 {入场费} {货币}。\n请选择一个地点：\n{场景列表}\n请在 {选择超时分钟} 分钟内发送 /摸鱼躲猫猫 躲 编号。", ("{昵称}", "{入场费}", "{货币}", "{场景列表}", "{选择超时分钟}", "{日期}")),
    ...
    TemplateDefinition("/摸鱼躲猫猫", "expired", "游戏已取消", "选择已超时，本局已取消，入场费和次数已返还。", ("{日期}",)),
    TemplateDefinition("/摸鱼躲猫猫", "found", "被系统找到", "【系统巡查】巡查 {巡查地点}\n你被系统找到了，本局结束。", ("{昵称}", "{巡查地点}", "{余额}", "{货币}", "{日期}")),
    TemplateDefinition("/摸鱼躲猫猫", "won", "躲藏成功", "【系统巡查】巡查 {巡查地点}\n躲藏成功，获得 {奖励} {货币}。当前余额：{余额} {货币}。", ("{昵称}", "{巡查地点}", "{奖励}", "{余额}", "{货币}", "{日期}")),
)
