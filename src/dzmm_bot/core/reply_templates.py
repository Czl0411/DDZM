...
TEMPLATE_DEFINITIONS = (
    ...
    TemplateDefinition("/甩锅游戏", "exploded", "锅已爆炸", "【甩锅游戏】锅爆炸了，{失败者} 背锅。", ("{失败者}", "{日期}")),
    TemplateDefinition("/甩锅游戏", "turn_timeout", "操作超时", "【甩锅游戏】操作超时，{失败者} 背锅。", ("{失败者}", "{日期}")),
    ...
    TemplateDefinition("/甩锅", "settled", "已爆锅", "锅已经爆炸，{失败者} 背锅；其他玩家每人获得 1 {货币}。", ("{失败者}", "{货币}", "{日期}")),
    TemplateDefinition("/退出甩锅", "left_signup", "退出报名", "你已退出甩锅游戏报名。", ("{日期}",)),
    TemplateDefinition("/退出甩锅", "settled", "主动退出", "{失败者} 主动退出并背锅，本局结束。", ("{失败者}", "{日期}")),
